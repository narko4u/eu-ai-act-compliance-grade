...
docs-ci validates that the HTML parses and all structured files are well-formed on every pull request and push to main.

Run the same checks locally:

```sh
python3 -m html.parser based check via docs-ci
```
